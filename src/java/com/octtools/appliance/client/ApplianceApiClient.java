...
public class ApplianceApiClient {
    ...
    private static final long INITIAL_RETRY_DELAY_MS = 1000; // Start with 1 second delay
    private static final int RETRY_BACKOFF_MULTIPLIER = 2; // Double delay each retry (1s, 2s, 4s)
